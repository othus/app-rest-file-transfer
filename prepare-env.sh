...
#
# Generated key to app-sender and app-receiver containers to allow symmetric encryption and decryption.
# input should be mounted  to /usr/share/app-sender/input of app-sender.
# status-db should be mounted  to /usr/share/app-sender/status-db of app-sender.
# output should be mounted  to /usr/share/app-receiver/output of app-receiver.
